...
##############################
# Aca hay que generar coordenadas aleatorias
rd.seed(seed)
...
write_sub_im(np.reshape(big_target_vector,(1000,1000)), the_list, output_dir, n_patches, seed, patch_width, patch_height, "red", "mask")
...
patch_width = size*2 + 1
patch_height = size*2 + 1
#com.write_sub_im(image, new_list, outPyDir, new_n_patches, seed, patch_width, patch_height, "red", "filtered")
#com.write_sub_im(mask_im, new_list, outPyDir, new_n_patches, seed, patch_width, patch_height, "red", "filtered_" +channel_name+ "_mask", mem_number=new_mem_estim, cMap="gray")
#com.write_sub_im(mask, new_list, outPyDir, new_n_patches, seed, patch_width, patch_height, "red", "filtered_mask", mem_number=new_mem_gs,cMap="gray")
...
#	com.write_sub_im(image, sel_patches_list, outPyDir, len(sel_patches_list),seed, patch_width, patch_height, "green", "selected")
#	com.write_sub_im(mask, sel_patches_list, outPyDir, len(sel_patches_list),seed, patch_width, patch_height, "green", "mask_selected", mem_number=gs_number)
#	com.write_sub_im(mask_im, sel_patches_list, outPyDir, len(sel_patches_list),seed, patch_width, patch_height, "green", channel_name + "_mask_selected", mem_number=es_number)
